            ...
            switch (webRequest.result)
            {
                case UnityWebRequest.Result.Success:
                    ...
                    using (webRequest2)
                    {
                        ...
                        Debug.Log(webRequest2.error);
                        switch (webRequest2.result)
                        {
                            case UnityWebRequest.Result.Success:

                                Debug.Log(webRequest2.downloadHandler.text);
                                ...
                                UserInfo userInfo = JsonConvert.DeserializeObject<UserInfo>(webRequest2.downloadHandler.text);
